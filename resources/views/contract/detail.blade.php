<x-app-layout title="Detail Kontrak">
    <div class="card invoice-preview-card mb-3">
        ...
        <div class="px-4">
            <h5 class="mb-1 fw-bolder">ONBOARDING KONTRAK OUTSOURCING</h5>
                    ...
                    <table class="table table-sm border-top m-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <h6 class="mb-0 fw-bolder">
                                        {{ rupiah($contract->inv_per_bulan) }}
                                    </h6>
                                    <p class="mb-0 text-muted">
                                        <em>{{ terbilang($contract->inv_per_bulan) }}</em>
                                    </p>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <h6 class="mb-0 fw-bolder">
                                        @if ($contract->tgl_cutoff == 't')
                                            Akhir Bulan
                                        @else
                                            Tanggal {{ $contract->tgl_cutoff }} Tiap Bulannya
                                        @endif
                                    </h6>
                                </td>
                            </tr>
                    ...
                    <table class="table table-sm border-top m-0">
                        <tbody>
                            <tr>
                                ...
                                <td width="2%">:</td>
                                <td class="text-nowrap">{{ rupiah($contract->salary) }}</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap">Fee Management</td>
                                <td>:</td>
                                <td class="text-nowrap">{{ rupiah($contract->fee_management) }}</td>
                            </tr>
                            {{-- <tr>
                                <td class="text-nowrap">BPJS Kesehatan</td>
                                <td>:</td>
                                <td class="text-nowrap">{{ rupiah($contract->bpjs_kes) }}</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap">BPJS Tenaga Kerja</td>
                                <td>:</td>
                                <td class="text-nowrap">{{ rupiah($contract->bpjs_tk) }}</td>
                            </tr> --}}
                            <tr>
                                <td class="text-nowrap">PPN</td>
                                <td>:</td>
                                <td class="text-nowrap">{{ rupiah($contract->ppn) }}</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap">PPH</td>
                                <td>:</td>
                                <td class="text-nowrap">{{ rupiah($contract->pph) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-wrap">
                                                                <h6 class="mb-0 fw-bolder">
                                                                    @if ($item->tgl_cutoff == 't')
                                                                        Akhir Bulan
                                                                    @else
                                                                        Tanggal {{ $item->tgl_cutoff }} Tiap
                                                                        Bulannya
                                                                    @endif
                                                                </h6>
                                                            </td>
